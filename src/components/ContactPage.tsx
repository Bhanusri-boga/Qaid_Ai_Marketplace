...
const supportOptions = [
  {
    ...
    description: 'Questions about QAID, pricing, or general information',
    icon: Mail,
    responseTime: '24 hours',
    contact: 'hello@qaid.ai'
  },
  {
...
const faqData = [
  {
    question: 'How do I get started with QAID AI agents?',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Have questions about QAID AI agents? Need help getting started? 
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Quick answers to common questions about QAID
              </p>
            </div>
          ...
          {/* CTA Section */}
          <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20 rounded-lg p-8 text-center mb-16">
            ...
            <p className="text-muted-foreground mb-6">
              Join thousands of businesses already using QAID AI agents to automate their operations.
            </p>
