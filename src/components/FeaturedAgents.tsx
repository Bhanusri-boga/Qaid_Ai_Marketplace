  ...
  return (
    <section className="py-20 sm:py-32 bg-background">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 !px-20 sm:px-8 lg:px-10  ">
          {featuredAgents.map((agent) => {
            const IconComponent = agent.icon
            return (
              <Card 
                key={agent.id} 
                className="group w-full !max-w-xs hover:shadow-lg transition-all duration-300 cursor-pointer border border-gray-300 hover:border-gray-300 bg-card relative overflow-hidden"
              ...
              >
                ...
                <CardContent className="pb-4">
                  ...
                  <Badge variant="outline" className="text-xs mb-3 border-gray-300">
                    {agent.category}
                  </Badge>
                </CardContent>
        ...
        <div className="text-center">
          <Button 
            size="lg" 
            variant="outline" 
            className="px-10 py-6 text-lg font-medium rounded-xl border-2 !border-gray-300 hover:bg-gray-100 transition-all duration-300 shadow-md hover:shadow-lg !outline-none !ring-0 !focus:outline-none !focus:ring-0 !focus:border-gray-300 !focus-visible:outline-none !focus-visible:ring-0 !focus-visible:border-gray-300"
