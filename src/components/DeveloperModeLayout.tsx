...
import { CustomNodeDevelopment } from './CustomNodeDevelopment'
import { DeploymentSettings } from './DeploymentSettings'
import { TestDebugInterface } from './TestDebugInterface'
...
export function DeveloperModeLayout({ onBack, userWallet }: DeveloperModeLayoutProps) {
  ...
  const renderMainContent = () => {
    switch (currentView) {
      case 'dashboard':
        return <DeveloperDashboard onSelectWorkflow={setSelectedWorkflow} />
      case 'builder':
