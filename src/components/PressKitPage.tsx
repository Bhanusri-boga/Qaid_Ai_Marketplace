...
export function PressKitPage({ onViewChange, isLoggedIn, onShowAuth }: PressKitPageProps) {
                  ...
                  <div className="space-y-8">
                    {milestones.map((milestone, index) => (
                      <div key={index} className="relative flex items-start gap-6">
                        <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-purple-600 text-white text-sm font-bold z-10">
                          {index + 1}
                        </div>
