...
const timeline = [
  {
    ...
    description: 'QAID was founded with a vision to democratize AI automation for businesses of all sizes.'
  },
  {
    year: '2022',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  QAID was founded in 2021 by a team of AI researchers and engineers who witnessed 
                ...
                <p>
                  Today, QAID serves over 50,000 businesses worldwide, from small startups to 
